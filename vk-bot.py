...
def handle_message(event):
    ...
    if text.upper() == 'НАЧАТЬ':
        ...
        send_message(
            user_id,
            "🙌 Приветствую администратор, в данном боте ты сможешь оставить свою наводку на нарушение или какую то ошибку в игре. Для начала работы выбери сервер из списка:",
        ...
        send_message(
            user_id,
            f"Ты выбрал сервер: {text}. Напишите наводку на нарушителя или напиши с какой ошибкой ты столкнулся в игре ⚠️\n\nНе забудь указать NickName нарушителя и доказательства при наличии 😈"
        )
        return
